...
//     version 1.17.0
//     from Assets/pruebaInput.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/pruebaInput.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @PruebaInput: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ""maps"": [
        {
            ""name"": ""New action map"",
            ""id"": ""585d1897-9733-4eff-a6c3-71ac772ec5c8"",
            ""actions"": [
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""2daa0646-c3e3-4d43-8f01-1e1f204932ec"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""5781c900-7d13-4389-97b4-5d56e6a4ff60"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""709a73d9-8149-4003-8e57-44f74f3e5eaa"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": ""Press"",
                    ""processors"": ""Normalize(min=1,max=5)"",
                    ""groups"": """",
                    ""action"": ""New action"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
    ...
    ~@PruebaInput()
    {
        UnityEngine.Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, PruebaInput.Newactionmap.Disable() has not been called.");
    }
    ...
    {
        private @PruebaInput m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public NewactionmapActions(@PruebaInput wrapper) { m_Wrapper = wrapper; }
        /// <summary>
